        ...
        <div className='container'>
            ...
            items-center'>
                <div data-aos="zoom-in">
                    <img  className="max-w-[400px] h-[350px] w-full mx-auto
                    object-cover"  src={BannerImg} alt="BannerImg" />
                </div>
               
               <div className="flex flex-col justify-center gap-6 sm:pt-0">
                <h1 data-aos = "fade-up" className="text-3xl sm:text-4xl font-bold ">Winter Sale upto 50% off</h1>
                <p data-aos="fade-up" className="text-sm text-gray-500 tracking-wide leading-5">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Commodi cupiditate ipsum labore odio laborum earum libero nulla nam, consequuntur ut perferendis mollitia dolorum accusantium eum ea totam porro,
                 saepe quae numquam sed?</p>
